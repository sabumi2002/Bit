      ...
      <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="btns">
              <router-link to="/m.register" tag="a" class="btn-menu animated fadeInUp scrollto">접수하기</router-link>
              <a href="#book-a-table" class="btn-book animated fadeInUp scrollto">관 계 자</a>
            </div>
          </div>
