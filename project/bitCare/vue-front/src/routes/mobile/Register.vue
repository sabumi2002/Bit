        ...
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="container text-left">
              <h1 style="font-weight: 500;">휴대폰번호 <span>또는</span></h1>
              <h1 style="font-weight: 500;">주민등록번호<span>를 입력해주세요.</span></h1>
            </div>
            <!--            휴대폰, 주민번호등록 div-->
            <div>
              <ul class="menu align-center expanded text-center SMN_effect-21 flex-nowrap m-2">
                <li>
              ...
              <div v-if="isPhoneCheck" class="m-3">
          ...
          <div class="col-lg-4 d-flex justify-content-center position-relative">
            <div>
          ...
          <button class="btn btn-primary mt-2 w-25">다음</button>
        </div>
      </div>
    </section>
  </div>
