...
public class UserViewer {
    ...
    public void setCommentViewer(CommentViewer commentViewer){ this.commentViewer = commentViewer;}
    ...
    private void update() {
        ...
        if (logIn.getPassword().equals(oldPassword)) {
            ...
            boardViewer.userUpdate(logIn);  // 보드 실시간 반영
            commentViewer.userUpdate(logIn);    // 댓글 실시간 반영
        } else {
            System.out.println("회원 정보 변경에 실패하였습니다.");
        }
    }
    ...
    private void delete() {
        ...
        if (yesNo.equalsIgnoreCase("Y")) {
            ...
            if (password.equals(logIn.getPassword())) {
                boardViewer.userDelete(logIn); // 보드 실시간 반영
                commentViewer.userDelete(logIn); // 유저 실시간 반영
