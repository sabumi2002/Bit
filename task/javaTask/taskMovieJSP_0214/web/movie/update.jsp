...
<head>
    ...
    <script defer src="/js/movie/update.js"></script>
    <!-- CSS only -->
    ...
    <div class="inner">
        ...
        <div class="data_box">
            ...
            <div class="input-group">
                ...
                <textarea class="form-control" id="input-content" name="content" aria-label="With textarea"></textarea>
            </div>




            <p>등급 : <select class="form-select form-select-lg mb-3" id="input-rank" aria-label=".form-select-lg example"
                            name="rank">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" id="input-release" name="release" class="form-control" aria-label="Sizing example input"
                       aria-describedby="inputGroup-sizing-default">
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" id="input-length" name="length" class="form-control" aria-label="Sizing example input"
                       aria-describedby="inputGroup-sizing-default">
            </div>
